...
function Users() {
  ...
  return (
    <div className="container mx-auto p-8">
      <h1 className="txt-main text-4xl font-bold text-center mb-8">Usuarios</h1>
      <div className="flex justify-end">
        <button
          onClick={openModal}
          type="button"
          class="text-white btn-main btn-main:hover focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700"
        >
          Registrar
        </button>
        {/* <button
